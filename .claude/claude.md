...
- **dockerfile.md** — Build documentation for the allin1 Docker image (dependency pinning, ARM/x86 notes, pitfalls).
- **Dockerfile** — Builds the allin1 music analysis Docker image (CPU-only, PyTorch 2.2.0 + NATTEN 0.15.1). Native ARM64 on Apple Silicon.
