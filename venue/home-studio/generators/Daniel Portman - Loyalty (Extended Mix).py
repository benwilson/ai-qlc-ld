#!/usr/bin/env python3
"""
Show Generator: Daniel Portman - Loyalty (Extended Mix)
=======================================================
BPM: 125 | Duration: ~6:36 | Genre: Progressive / Melodic House
...
- "Loyalty" motif: recurring center reunions after phrase movement.
"""
...
SONG_STEM = "Daniel Portman - Loyalty (Extended Mix)"
...
scenes = [scene("Blackout", *blackout_all(), path="Loyalty")]
